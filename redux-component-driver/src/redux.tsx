...
export class ReduxComponentDriver<C extends ReduxComponent<C>, S, A extends Action<any>> extends ComponentDriver<InferProps<C>> {
  constructor(component: C, store: Store<S, A>) {
